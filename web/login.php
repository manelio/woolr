    ...
    <div class="well well-lg">
      <div class="row">
        <div class="col-sm-6 col-xs-12">
          <div class="row">
            <div class="col-xs-12"><h3>Login social</h3></div>
          </div>
          <div class="row">
        ...
        <div class="col-sm-6 col-xs-12">
          <div class="row">
            <div class="col-xs-12"><h3>Login clásico</h3></div>
          </div>
          <div class="row">
            <div class="col-xs-12">
                ...
                <div class="input-group">
                  ...
                  <input id="name" name="username" value="{$__username}" class="form-control input-lg" placeholder="Usuario o email" required="required" maxlength="100" type="text" data-original-title="" title="">
                </div>
                ...
                <div class="form-group">
                  <button type="submit" value="login" id="btn-signup" class="btn btn-block btn-primary btn-lg">Login</button>
                </div>

                <div class="checkbox">
                  <label>
                    <input id="remember" name="persistent" type="checkbox" /> Recuérdame
                  </label>
                </div>
